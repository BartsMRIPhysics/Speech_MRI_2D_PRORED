...
if torch.cuda.is_available():
    print(f"GPU is available. CUDA device count: {torch.cuda.device_count()}")
else:
...
parser.add_argument('--seed', type=int,
                    default=2222, help='random seed initial 2222') 
...
args.exp = 'PRORED' + str(args.img_size)
